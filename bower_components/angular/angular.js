...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * # General usage
     * The `$http` service is a function which takes a single argument â€?a configuration object â€?     * that is used to generate an HTTP request and returns  a {@link ng.$q promise}
     ...
     * the `then` method to register callbacks, and these callbacks will receive a single argument â€?     * an object representing the response. See the API signature and type info below for more
     * details.
     *
     ...
     *    - **transformRequest** â€?     *      `{function(data, headersGetter)|Array.<function(data, headersGetter)>}` â€?     *      transform function or an array of such functions. The transform function takes the http
     *      request body and headers and returns its transformed (typically serialized) version.
     *    - **transformResponse** â€?     *      `{function(data, headersGetter)|Array.<function(data, headersGetter)>}` â€?     *      transform function or an array of such functions. The transform function takes the http
